...
#ifndef MyPluginFXParams_H
#define MyPluginFXParams_H
...
static const AkPluginParamID PARAM_RATIO_ID = 1;
static const AkUInt32 NUM_PARAMS = 2;

struct MyPluginRTPCParams
{
    AkReal32 fThreshold;
    AkReal32 fRatio;
};

struct MyPluginNonRTPCParams
{
};

struct MyPluginFXParams
    : public AK::IAkPluginParam
{
    MyPluginFXParams();
    MyPluginFXParams(const MyPluginFXParams& in_rParams);
    ...
    MyPluginRTPCParams RTPC;
    MyPluginNonRTPCParams NonRTPC;
};

#endif // MyPluginFXParams_H
